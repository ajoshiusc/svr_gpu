...
GROUND_TRUTH_DIR = os.path.join(basepath, "data/ground_truths")
OUTPUT_DIR = os.path.join(basepath, "data/sms_sim_stacks_generated")
...
def main():
    ...
    for gt_idx, gt_path in enumerate(ground_truth_files, 1):
        ...
        for motion_level, mb_factor, num_stacks in product(
            MOTION_LEVELS.keys(), MB_FACTORS, NUM_STACKS_OPTIONS
        ):
